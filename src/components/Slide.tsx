/**
 * Individual slide component for images and videos
 *
 * Handles:
 * - Slide positioning and transitions
 * - Video/image rendering with proper object-fit
...
interface SlideProps {
  ...
  /** Video element ref (only attached to active video) */
...
/**
 * Renders a single slide (image or video)
 * Manages position, opacity, and z-index during transitions
 */
