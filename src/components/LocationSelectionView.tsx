 ...
 *
 * Features:
 * - Grid of gym location buttons
 * - Sync scheduler configuration
 * - Next sync time display
 *
 * @module components/LocationSelectionView
 */
...
/**
 * Dashboard for selecting gym location and configuring sync
 */
const LocationSelectionView: React.FC = () => {
  ...
  const schedulerOptions = [
    ...
    { value: "daily1am", label: "Täglich um 1:00 Uhr" },
  ];
